...
Ingredient.create :name => "Jauhelihaa"    #1
Ingredient.create :name => "Maitoa"        #2
Ingredient.create :name => "Kananmunaa"    #3
Ingredient.create :name => "Perunaa"       #4
Ingredient.create :name => "Mansikkaa"     #5
Ingredient.create :name => "Jäätelöä"      #6
Ingredient.create :name => "Tomaattia"     #7
Ingredient.create :name => "Kurkkua"       #8
Ingredient.create :name => "Korppujauhoja" #9

puts 'CREATING RECIPE_INGREDIENTS'
